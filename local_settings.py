...
SOURCE_ACCOUNTS = [u“AndrewUdell“] #A list of comma-separated, quote-enclosed Twitter handles of account that you'll generate tweets based on. It should look like ["account1", "account2"]. If you want just one account, no comma needed.
ODDS = 4 #How often do you want this to run? 1/4 times?
...
TWEET_ACCOUNT = u“AndrewEbooks” #The name of the account you're tweeting to.
