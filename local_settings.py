...
SOURCE_ACCOUNTS = [“andrewu_ebooks“] #A list of comma-separated, quote-enclosed Twitter handles of account that you'll generate tweets based on. It should look like ["account1", "account2"]. If you want just one account, no comma needed.
...
TWEET_ACCOUNT = “andrewu_ebooks” #The name of the account you're tweeting to.
